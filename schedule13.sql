...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 17 2020 г., 12:36
...
INSERT INTO `day` (`dai_id`, `name`) VALUES
(1, 'Понедельник'),
(2, 'Вторник'),
(3, 'Среда'),
(4, 'Четверг'),
...
--
ALTER TABLE `day`
  MODIFY `dai_id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
ALTER TABLE `schedule`
  ...
  ADD CONSTRAINT `schedule_ibfk_3` FOREIGN KEY (`day_id`) REFERENCES `day` (`dai_id`),
...
ALTER TABLE `user`
  ...
  ADD CONSTRAINT `user_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `student` (`user_id`);
COMMIT;
